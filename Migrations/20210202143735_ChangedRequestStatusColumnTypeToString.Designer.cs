...
namespace dadachMovie.Migrations
{
    ...
    [Migration("20210202143735_ChangedRequestStatusColumnTypeToString")]
    partial class ChangedRequestStatusColumnTypeToString
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SerieUser", b =>
                {
                    b.Property<int>("FavoriteSeriesId")
                        .HasColumnType("int");

                    b.Property<Guid>("UsersId")
                        .HasColumnType("char(36)");

                    b.HasKey("FavoriteSeriesId", "UsersId");
            ...
            modelBuilder.Entity("dadachMovie.Entities.Movie", b =>
                {
                    ...
                    b.Property<string>("ImdbRatesCount")
                        .HasColumnType("longtext CHARACTER SET utf8mb4");
                    ...
                    b.Property<string>("MetacriticRate")
                        .HasColumnType("longtext CHARACTER SET utf8mb4");
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            BannerImage = "http://localhost:5000/movies/defaultbanner.png",
            ...
            modelBuilder.Entity("dadachMovie.Entities.Role", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("dadachMovie.Entities.Serie", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("dadachMovie.Entities.SeriesCasts", b =>
                {
                    b.Property<int>("SerieId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("dadachMovie.Entities.SeriesRating", b =>
                {
                    b.Property<int>("SerieId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("dadachMovie.Entities.UserActivity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CountrySerie", b =>
                {
                    ...
                    b.HasOne("dadachMovie.Entities.Serie", null)
                        .WithMany()
            ...
            modelBuilder.Entity("SerieUser", b =>
                {
                    b.HasOne("dadachMovie.Entities.Serie", null)
                        .WithMany()
                        .HasForeignKey("FavoriteSeriesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("dadachMovie.Entities.Comment", b =>
                {
                    ...
                    b.HasOne("dadachMovie.Entities.Serie", "Serie")
                        .WithMany("Comments")
                        .HasForeignKey("SerieId");

                    b.HasOne("dadachMovie.Entities.User", "User")
                        .WithMany("Comments")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
