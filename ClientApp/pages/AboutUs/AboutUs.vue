<template>
  <div dir="rtl">
    <nav-bar />
    <div class="row">
      <side-bar class="col-md-5" />
      <div class="ct-pageWrapper container col-md-7" id="ct-js-wrapper">
        <section
          class="story-section company-sections ct-u-paddingBoth100 paddingBothHalf noTopMobilePadding"
          id="section"
        >
          <div class="container text-center about-title">
            <h2>
              درباره ما
            </h2>
            <h3 class="mt-4">
        ...
        <section
          class="culture-section company-sections py-5 paddingBothHalf noTopMobilePadding"
        >
          <div>
            <div>
              <h2>
                فعالیت های داداچ مویی
              </h2>
            </div>
            <div class="row ct-u-paddingBoth20">
              <div class="col-xs-6 col-md-4">
                <div class="company-icons-white">
                  ...
                  <p class="company-icons-subtext hidden-xs">
                    ...
                    با استفاده از طراحان گرافه و مجله در ستون و سطرآنچنان که
                    لازم است
                  </p>
                </div>
              </div>
              <div class="col-xs-6 col-md-4">
                <div class="company-icons-white">
                  ...
                  <p class="company-icons-subtext hidden-xs">
                    و با استفاده از طراحان گرافه و مجله در ستون و سطرآنچنان که
                    لازم است
                  </p>
                </div>
              </div>
            ...
            <a
              class="ct-u-marginTop60 btn btn-solodev-red-reversed btn-fullWidth-sm ct-u-size19"
              href="/login"
              >به مجموعه داداچ مویی بپیوندید</a
            >
          </div>
        </section>
...
.ct-pageWrapper {
  background-color: #34363ad0 !important;
}
.separator-type,
.title-type,
.intro-type,
...
section.culture-section.company-sections.py-5.paddingBothHalf.noTopMobilePadding {
  margin-left: 1rem;
  padding-left: 0.5rem;
}
.slick-slider {
