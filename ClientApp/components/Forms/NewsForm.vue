  ...
  <div>
    <form class="mt-5">
      <div class="row">
        <div class="col-md-6">
          <div class="form-group">
            ...
            <form-input label="عنوان خبر" :required="true" id="name" />
          </div>
        </div>
        <div class="col-md-6">
          <label for="exampleFormControlInput1"></label>
          <form-input label="دسته بندی" :required="true" id="name" />
        </div>
      </div>
      ...
      <div class="row mt-5">
        <div class="col-md-12">
          <div class="form-group">
            <label for="exampleFormControlTextarea2" class="textarea-lable"
              >شرح خبر</label
            >
            <textarea
